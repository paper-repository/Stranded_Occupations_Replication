...
export delimited using "$temp/jskill_pa.csv", replace //for further analysis
...
*========================
* Generate the two-digit industry prefix
* For example, 211120 -> 21
*========================
gen naics2 = floor(NAICS2022/10000)

*========================
* Generate the matching-result variable
*========================
gen naics_group = ""
...
*========================
* Generate the official English name variable
*========================
gen naics_name = ""
...
save "$temp/simocc_08", replace
 ...
 export excel using "$temp/simocc_08.xlsx", firstrow(variables) replace

 
use "$temp/occupation_information.dta"

keep if strandind_new_ocu==1
 
 export excel using "$temp/strandind_new_ocu.xlsx", firstrow(variables) replace
...
use "$temp/simocc_1",clear
 ...
 export excel using "$temp/simocc_1.xlsx", firstrow(variables) replace

//fig5b
 use "$temp/simocc_851", clear

   export excel using "$temp/simocc_851.xlsx", firstrow(variables) replace
  
 
 //fig5c
use "$temp/simocc_885", clear

 export excel using "$temp/simocc_885.xlsx", firstrow(variables) replace
